...
##### **현재 진행 중**
 ...
 - 나홀로 프로젝트 진행 中: Architect AutoUpdate CrawlingEngine for Auction(free of problems in the analysis of rights) (팀 2~3명 모집^^)
  · 목적: 경매 입찰적합品 자동 필터링
  · 1차 목표: 권리분석上 하자無 물건 자동 수집 및 업데이트 라인 구축
  · 2차 목표
  · 추후방향: 各케이스별 필터링 정교화, "손품" 자동화를 위한 2차 
